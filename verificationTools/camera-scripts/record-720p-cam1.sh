...
#usage: ./record-720p-cam1.sh <video bitrate> <filename>
...
gst-launch-1.0 -e v4l2src device=/dev/video7 ! video/x-raw,format=NV12,width=1280,height=720 ! v4l2h264enc extra-controls="controls,h264_profile=4,video_bitrate=$1000000;" ! h264parse ! mp4mux ! filesink location=$2.h264
