...
gst-launch-1.0 -e v4l2src device=/dev/video0  ! video/x-raw,format=UYVY,width=1920,height=1080,framerate=30/1 ! videoconvert ! video/x-raw,format=NV12,width=1920,height=1080,framerate=30/1 ! v4l2h264enc extra-controls="controls,h264_profile=4,video_bitrate=$1000000;" ! h264parse ! mp4mux ! filesink location=$2.h264
