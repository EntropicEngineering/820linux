...
#usage: ./record-5mp-cam2.sh <video bitrate> <filename>
...
gst-launch-1.0 -e v4l2src device=/dev/video0  ! video/x-raw,format=UYVY,width=2592,height=1944,framerate=15/1 ! videoconvert ! video/x-raw,format=NV12,width=2592,height=1944,framerate=15/1 ! v4l2h264enc extra-controls="controls,h264_profile=4,video_bitrate=$1000000;" ! h264parse ! mp4mux ! filesink location=$2.h264
