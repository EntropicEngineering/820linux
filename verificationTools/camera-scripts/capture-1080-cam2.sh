...
#usage: ./capture-1080-cam2.sh <filename>
...
gst-launch-1.0 v4l2src device=/dev/video0 num-buffers=1 ! video/x-raw,format=UYVY,width=1920,height=1080,framerate=30/1 ! videoconvert ! 'video/x-raw,format=NV12,width=1920,height=1080,framerate=30/1' ! jpegenc ! filesink location=$1.jpg
